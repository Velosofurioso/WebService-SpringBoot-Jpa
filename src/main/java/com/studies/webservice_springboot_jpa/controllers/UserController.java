...
public class UserController {
	...
	public ResponseEntity<Void> insert(@PathVariable(required = true) Long id){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<User> update(@PathVariable(required = true) Long id, @RequestBody User user){
